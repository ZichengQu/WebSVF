...
var USERIP = process.env.USER_IP || "localhost";

httpServer.listen(PORT, function () {
    console.log(`HTTP Server is running on: http://${USERIP}:%s`, PORT);
});
httpsServer.listen(SSLPORT, function () {
    console.log(`HTTPS Server is running on: https://${USERIP}:%s`, SSLPORT);
});
